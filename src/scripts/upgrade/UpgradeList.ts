 ...
 */
 export const UpgradeList: Record<UpgradeId, Upgrade> = {
    [UpgradeId.PlainsSize1]: new Upgrade(UpgradeId.PlainsSize1, 'Increase Plains Farm size to 7x7.', {'Sky Bean': 10}),
    [UpgradeId.PlainsSize2]: new Upgrade(UpgradeId.PlainsSize2, 'Increase Plains Farm size to 9x9.', {'Sky Bean': 1000}, new UpgradePurchasedRequirement('7x7 Plains')),
};